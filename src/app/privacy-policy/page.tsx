    ...
    <div className={styles.privacy}>
        <div className='container'>
            ...
            <div className={styles.body}>
                ...
                <p>
                    1.1 Настоящая Политика конфиденциальности описывает, какие личные данные собираются и обрабатываются сайтом anyboost.ru (далее - 'Сайт') и как эти данные используются.
                </p>
                <p>
